    ...
    <Container maxWidth="lg">
      ...
      >
        <Paper
          ...
          sx={{
            p: { xs: 4, md: 6 },
            borderRadius: 4,
            background: 'linear-gradient(135deg, #1976d2 0%, #00bcd4 50%, #2196f3 100%)',
            color: '#fff',
            position: 'relative',
            overflow: 'hidden',
        ...
        >
          <Box sx={{ position: 'relative', zIndex: 2, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, alignItems: 'center', gap: 6, minHeight: '400px' }}>
            ...
            <Box sx={{ flex: 1, textAlign: { xs: 'center', md: 'left' }, order: { xs: 2, md: 1 } }}>
              ...
              >
                I'm an AIML Engineer and Full Stack Developer who is passionate in Programming
            </Typography>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', order: { xs: 1, md: 2 } }}>
              <Avatar
                ...
                sx={{
                  ...
                  boxShadow: '0 25px 50px rgba(0,0,0,0.3), 0 0 30px rgba(33, 150, 243, 0.3)',
                  transition: 'all 0.4s ease',
                  '&:hover': {
                    transform: 'scale(1.08) rotate(5deg)',
                    boxShadow: '0 35px 70px rgba(0,0,0,0.4), 0 0 40px rgba(33, 150, 243, 0.5)',
      ...
      <div
        ...
        style={{
          ...
          transform: isQuickLinksVisible ? 'translateY(0px) scale(1)' : 'translateY(60px) scale(0.95)',
            ...
            sx={{
              ...
              textDecoration: 'none',
                ...
                '&:hover': { 
                  ...
                  boxShadow: '0 20px 40px rgba(0,0,0,0.15), 0 0 0 2px rgba(59, 130, 246, 0.8), 0 0 30px rgba(59, 130, 246, 0.6), 0 0 60px rgba(59, 130, 246, 0.3)',
      ...
      <div
        ...
        style={{
          ...
          transform: isContactVisible ? 'translateY(0px) scale(1)' : 'translateY(60px) scale(0.95)',
          transition: 'all 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
          marginBottom: '48px',
        }}
      >
      <Paper
        ...
        >
          <Typography variant="h4" gutterBottom sx={{ fontWeight: 700, color: '#1976d2', mb: 2 }}>
      ...
      <div
        ...
        style={{
          ...
          transform: isSocialVisible ? 'translateY(0px) scale(1)' : 'translateY(60px) scale(0.95)',
          transition: 'all 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)',
        }}
      >
        <Paper
        ...
        >
          <Typography variant="h6" sx={{ textAlign: 'center', mb: 3, fontWeight: 600, color: '#1976d2' }}>
            Connect With Me
          </Typography>
