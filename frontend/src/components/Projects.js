    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      <Box sx={{ mb: 5 }}>
        ...
        >
          ...
          >
            Explore a curated selection of my work, where I blend creativity,
            technology, and problem-solving to deliver impactful solutions. I
            enjoy collaborating on innovative projects and always strive for
